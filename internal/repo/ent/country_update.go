...
func (cu *CountryUpdate) SetNameCn(s string) *CountryUpdate {
	cu.mutation.SetNameCn(s)
	return cu
}

// SetNillableNameCn sets the "name_cn" field if the given value is not nil.
func (cu *CountryUpdate) SetNillableNameCn(s *string) *CountryUpdate {
	if s != nil {
		cu.SetNameCn(*s)
	}
	return cu
...
func (cu *CountryUpdate) AddPoiIDs(ids ...uuid.UUID) *CountryUpdate {
	cu.mutation.AddPoiIDs(ids...)
	return cu
}

// AddPoi adds the "poi" edges to the PointsOfInterest entity.
func (cu *CountryUpdate) AddPoi(p ...*PointsOfInterest) *CountryUpdate {
...
// SetNameCn sets the "name_cn" field.
func (cuo *CountryUpdateOne) SetNameCn(s string) *CountryUpdateOne {
	cuo.mutation.SetNameCn(s)
	return cuo
}

// SetNillableNameCn sets the "name_cn" field if the given value is not nil.
func (cuo *CountryUpdateOne) SetNillableNameCn(s *string) *CountryUpdateOne {
	if s != nil {
		cuo.SetNameCn(*s)
	}
	return cuo
...
// AddPoiIDs adds the "poi" edge to the PointsOfInterest entity by IDs.
func (cuo *CountryUpdateOne) AddPoiIDs(ids ...uuid.UUID) *CountryUpdateOne {
	cuo.mutation.AddPoiIDs(ids...)
	return cuo
}

// AddPoi adds the "poi" edges to the PointsOfInterest entity.
func (cuo *CountryUpdateOne) AddPoi(p ...*PointsOfInterest) *CountryUpdateOne {
	ids := make([]uuid.UUID, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
// ClearPoi clears all "poi" edges to the PointsOfInterest entity.
func (cuo *CountryUpdateOne) ClearPoi() *CountryUpdateOne {
	cuo.mutation.ClearPoi()
	return cuo
}

// RemovePoiIDs removes the "poi" edge to PointsOfInterest entities by IDs.
func (cuo *CountryUpdateOne) RemovePoiIDs(ids ...uuid.UUID) *CountryUpdateOne {
	cuo.mutation.RemovePoiIDs(ids...)
	return cuo
}

// RemovePoi removes "poi" edges to PointsOfInterest entities.
func (cuo *CountryUpdateOne) RemovePoi(p ...*PointsOfInterest) *CountryUpdateOne {
	ids := make([]uuid.UUID, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}

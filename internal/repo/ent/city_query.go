...
func (cq *CityQuery) QueryPoi() *PointsOfInterestQuery {
...
func (cq *CityQuery) WithPoi(opts ...func(*PointsOfInterestQuery)) *CityQuery {
	query := (&PointsOfInterestClient{config: cq.config}).Query()
...
func (cq *CityQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*City, error) {
	...
	if query := cq.withPoi; query != nil {
		if err := cq.loadPoi(ctx, query, nodes,
			func(n *City) { n.Edges.Poi = []*PointsOfInterest{} },
			func(n *City, e *PointsOfInterest) { n.Edges.Poi = append(n.Edges.Poi, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CityQuery) loadPoi(ctx context.Context, query *PointsOfInterestQuery, nodes []*City, init func(*City), assign func(*City, *PointsOfInterest)) error {

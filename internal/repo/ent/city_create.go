...
func (cc *CityCreate) SetNameEn(s string) *CityCreate {
	cc.mutation.SetNameEn(s)
	return cc
}

// SetNameCn sets the "name_cn" field.
func (cc *CityCreate) SetNameCn(s string) *CityCreate {
...
func (cc *CityCreate) AddPoiIDs(ids ...uuid.UUID) *CityCreate {
	cc.mutation.AddPoiIDs(ids...)
	return cc
}

// AddPoi adds the "poi" edges to the PointsOfInterest entity.
func (cc *CityCreate) AddPoi(p ...*PointsOfInterest) *CityCreate {
...
func (cc *CityCreate) check() error {
	...
	if _, ok := cc.mutation.NameEn(); !ok {
		return &ValidationError{Name: "name_en", err: errors.New(`ent: missing required field "City.name_en"`)}
	}
	...
	if _, ok := cc.mutation.NameCn(); !ok {
		return &ValidationError{Name: "name_cn", err: errors.New(`ent: missing required field "City.name_cn"`)}
	}

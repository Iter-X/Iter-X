...
const (
	// Label holds the string label denoting the dailyitinerary type in the database.
	Label = "daily_itinerary"
	...
	EdgePoi = "poi"
	// Table holds the table name of the dailyitinerary in the database.
	Table = "daily_itineraries"
	// TripTable is the table that holds the trip relation/edge.
	TripTable = "daily_itineraries"
	...
	DailyTripTable = "daily_itineraries"
...
// Columns holds all SQL columns for dailyitinerary fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the DailyItinerary queries.
...
// ByPoiField orders the results by poi field.
func ByPoiField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newPoiStep(), sql.OrderByField(field, opts...))
	}
}

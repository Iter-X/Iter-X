class TripApi {
  ...
  static const String listTripCollaborators =
      '/api/v1/trips/{id}/collaborators';
  static const String moveItineraryItem = '/api/v1/trips/{id}/itineraries/move';
  static const String addDay = '/api/v1/trips/{id}/day';

  static String getTripDetailUrl(String id) =>
      getTripDetail.replaceAll('{id}', id);
  ...
  static String listTripCollaboratorsUrl(String id) =>
      listTripCollaborators.replaceAll('{id}', id);

  static String moveItineraryItemUrl(String id) =>
      moveItineraryItem.replaceAll('{id}', id);

  static String addDayUrl(String id) => addDay.replaceAll('{id}', id);
}

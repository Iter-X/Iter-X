class TripApi {
  ...
  static const String createTripFromExternalLink = '/api/v1/trips/external-link';
  // 获取行程
  ...
  // 更新每日行程
  static const String updateDailyTrip = '/api/v1/trips/{trip_id}/daily/{daily_id}';
  // 删除每日行程
  static const String deleteDailyTrip = '/api/v1/trips/{trip_id}/daily/{daily_id}';
  // 获取每日行程列表
